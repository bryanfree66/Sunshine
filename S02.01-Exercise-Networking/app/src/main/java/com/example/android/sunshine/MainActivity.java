...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (8) Create a method that will get the user's preferred location and execute your new AsyncTask and call
    ...
    public class WeatherQueryTask extends AsyncTask<String, Void, String[]>{
        ...
        protected String[] doInBackground(String... strings) {
            ...
            try{
                ...
                String[] weatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonResponse);
                return weatherData;
            }
            catch(Exception e){
                e.printStackTrace();
