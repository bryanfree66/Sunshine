...
//  COMPLETE (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
    ...
    TextView mHighTempDisplay;
    TextView mLowTempDisplay;
    TextView mHumidityDisplay;
    TextView mWindDisplay;
    TextView mPressureDisplay;
...
//      COMPLETE (13) Find each of the TextViews by ID
        ...
        mHumidityDisplay = (TextView) findViewById(R.id.low_temperature);
