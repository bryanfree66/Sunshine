...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mErrorDisplayTestView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorDisplayTestView = (TextView) findViewById(R.id.tv_error_display);
